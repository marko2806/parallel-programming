...
// Create the two input vectors
    ...
    kernel = clCreateKernel(program, "copy_list", &ret);
...
void copy_list(double *A, double *B, int n) {
    size_t local_item_size = 64; // Divide work items into groups of 64
    size_t global_item_size = ceil(n / (double)local_item_size) * local_item_size; // Process the entire lists
